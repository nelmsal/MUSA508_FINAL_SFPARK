...
SFtracts19 <- 
  get_acs(geography = "tract", variables = 
            c("B25026_001E","B02001_002E","B15001_050E",
  ...
  mutate(
    ...
    commute_30_90min_pct = (workers_commute_30_90min/workforce_16)*100,
    Drive_Work_pct = (drove_to_work/workforce_16)*100,
    PublicTransport_work_pct = (public_transport_to_work/workforce_16)*100,          
    taxi_work_pct = (taxi_to_work/workforce_16)*100,          
    work_home_pct = (worked_from_home/workforce_16)*100,          
    walk_work_pct = (walked_to_work/workforce_16)*100,          
    motorcycle_work_pct = (motorcycle_to_work/workforce_16)*100,          
    other_way_work_pct = (other_commute_to_work/workforce_16)*100,          
    carpool_work_pct = (carpooled_to_work/workforce_16)*100,          
    households_car_pct = (Num_Vehicles/total_households)*100,          
    households_NOcar_pct = (House_holds_no_vehicles/total_households)*100
    )
